...
export function AdminAccessDenied() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-5 text-center">
      ...
      <p className="mt-6 max-w-md text-label-sm font-label-sm text-outline">
        <span className="material-symbols-outlined text-[16px] align-[-3px]">info</span>{" "}
        Demo tip: sign in with <span className="text-on-surface-variant">admin@localpulse.dev</span>{" "}
        / <span className="text-on-surface-variant">password123</span> to explore the platform console,
        or <span className="text-on-surface-variant">society@localpulse.dev</span> for a society dashboard.
      </p>
    </div>
  );
}
